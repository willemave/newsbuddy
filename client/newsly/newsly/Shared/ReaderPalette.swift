    ...
    var colors: ReaderPaletteColors {
        ...
        case .graphiteSlate:
            return ReaderPaletteColors(
                surfacePrimary: Self.adaptive(light: 0xf4f6f7, dark: 0x101214),
                surfaceSecondary: Self.adaptive(light: 0xffffff, dark: 0x191c20),
                surfaceTertiary: Self.adaptive(light: 0xe8edf1, dark: 0x22272d),
                surfaceContainer: Self.adaptive(light: 0xdce4ea, dark: 0x2a3037),
                surfaceContainerHigh: Self.adaptive(light: 0xccd7df, dark: 0x333a43),
                surfaceContainerHighest: Self.adaptive(light: 0xb9c7d2, dark: 0x3e4751),
                brandPrimary: Self.adaptive(light: 0x587285, dark: 0x8fa8bc),
                brandPrimaryStrong: Self.adaptive(light: 0x405b70, dark: 0x6f8ca3),
                brandSecondary: Self.adaptive(light: 0x746a80, dark: 0xb1a5bd),
                brandTertiary: Self.adaptive(light: 0x6f856f, dark: 0x9fb6a3),
        ...
        case .inkEucalyptus:
            return ReaderPaletteColors(
                surfacePrimary: Self.adaptive(light: 0xf3f7f4, dark: 0x0f1311),
                surfaceSecondary: Self.adaptive(light: 0xffffff, dark: 0x19201c),
                surfaceTertiary: Self.adaptive(light: 0xe6eee9, dark: 0x222b25),
                surfaceContainer: Self.adaptive(light: 0xd7e4dc, dark: 0x2a352d),
                surfaceContainerHigh: Self.adaptive(light: 0xc8d8ce, dark: 0x344139),
                surfaceContainerHighest: Self.adaptive(light: 0xb6cabd, dark: 0x405047),
                brandPrimary: Self.adaptive(light: 0x587865, dark: 0x8fb8a2),
                brandPrimaryStrong: Self.adaptive(light: 0x3f5f4d, dark: 0x6e9a83),
                brandSecondary: Self.adaptive(light: 0x587083, dark: 0x8aa5b8),
                brandTertiary: Self.adaptive(light: 0x8b6766, dark: 0xbd9998),
        ...
        case .charcoalDustyRose:
            return ReaderPaletteColors(
                surfacePrimary: Self.adaptive(light: 0xf8f4f5, dark: 0x121011),
                surfaceSecondary: Self.adaptive(light: 0xffffff, dark: 0x1d181a),
                surfaceTertiary: Self.adaptive(light: 0xefe6e8, dark: 0x271f22),
                surfaceContainer: Self.adaptive(light: 0xe3d5d9, dark: 0x32282b),
                surfaceContainerHigh: Self.adaptive(light: 0xd7c5cb, dark: 0x3e3136),
                surfaceContainerHighest: Self.adaptive(light: 0xc9b3bb, dark: 0x4b3b41),
                brandPrimary: Self.adaptive(light: 0x8a5c64, dark: 0xc79aa1),
                brandPrimaryStrong: Self.adaptive(light: 0x633e46, dark: 0xa97981),
                brandSecondary: Self.adaptive(light: 0x597184, dark: 0x8da8b8),
                brandTertiary: Self.adaptive(light: 0x74688e, dark: 0xaaa0c0),
        ...
        case .aubergineMist:
            return ReaderPaletteColors(
                surfacePrimary: Self.adaptive(light: 0xf5f4f8, dark: 0x111016),
                surfaceSecondary: Self.adaptive(light: 0xffffff, dark: 0x1c1a24),
                surfaceTertiary: Self.adaptive(light: 0xe9e6f0, dark: 0x262333),
                surfaceContainer: Self.adaptive(light: 0xddd8e8, dark: 0x302c40),
                surfaceContainerHigh: Self.adaptive(light: 0xd0c9dc, dark: 0x3a354d),
                surfaceContainerHighest: Self.adaptive(light: 0xc1b8cf, dark: 0x453f5b),
                brandPrimary: Self.adaptive(light: 0x576f86, dark: 0x91abc3),
                brandPrimaryStrong: Self.adaptive(light: 0x3e5369, dark: 0x6f8faa),
                brandSecondary: Self.adaptive(light: 0x805f7c, dark: 0xb59ab3),
                brandTertiary: Self.adaptive(light: 0x5f7d78, dark: 0x89b2aa),
        ...
        case .newspaperOxblood:
            return ReaderPaletteColors(
                ...
                surfaceSecondary: Self.adaptive(light: 0xfffdf8, dark: 0x1a1916),
                surfaceTertiary: Self.adaptive(light: 0xe7e2d4, dark: 0x24231f),
                surfaceContainer: Self.adaptive(light: 0xddd5c2, dark: 0x2e2b25),
                surfaceContainerHigh: Self.adaptive(light: 0xd1c7b2, dark: 0x38352d),
                surfaceContainerHighest: Self.adaptive(light: 0xc4b899, dark: 0x454035),
                brandPrimary: Self.adaptive(light: 0x864f4f, dark: 0xb87979),
                brandPrimaryStrong: Self.adaptive(light: 0x643939, dark: 0x965c5c),
                brandSecondary: Self.adaptive(light: 0x5a7180, dark: 0x91a8b7),
                brandTertiary: Self.adaptive(light: 0x69745e, dark: 0x9fa88f),
        ...
        case .porcelainGreen:
            return ReaderPaletteColors(
                surfacePrimary: Self.adaptive(light: 0xf3f7f4, dark: 0x0f1110),
                surfaceSecondary: Self.adaptive(light: 0xffffff, dark: 0x181b19),
                surfaceTertiary: Self.adaptive(light: 0xe5eee9, dark: 0x222722),
                surfaceContainer: Self.adaptive(light: 0xd7e3dd, dark: 0x2b332e),
                surfaceContainerHigh: Self.adaptive(light: 0xc8d7d0, dark: 0x354039),
                surfaceContainerHighest: Self.adaptive(light: 0xb9cbbf, dark: 0x404d45),
                brandPrimary: Self.adaptive(light: 0x637e6e, dark: 0xa8c5b4),
                brandPrimaryStrong: Self.adaptive(light: 0x486553, dark: 0x7fa38f),
                brandSecondary: Self.adaptive(light: 0x586f88, dark: 0x899fb7),
                brandTertiary: Self.adaptive(light: 0x806880, dark: 0xb49aaa),
