...
use newsly_worker::config::SummarizationWorkerProcessConfig;
...
async fn main() -> Result<()> {
    ...
    tracing::info!(
        ...
        "Newsly Rust summarization worker started; only rows stamped for the Rust runtime are claimable"
    );
