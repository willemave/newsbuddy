...
from app.models.api.integrations import DeleteUserLlmIntegrationResponse
...
def execute(db: Session, *, user_id: int, provider: str) -> DeleteUserLlmIntegrationResponse:
    ...
    return DeleteUserLlmIntegrationResponse(provider=provider)
