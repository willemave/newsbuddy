...
class NewsItemDiscussion(Base):
    ...
    summary_input_sha256 = Column(String(64), nullable=True)
    summary_comment_count = Column(Integer, nullable=True)
    summary_comment_fingerprints = Column(JSON, nullable=True)
    summary_seen_input_sha256 = Column(String(64), nullable=True)
    summary_seen_comment_count = Column(Integer, nullable=True)
    summary_seen_comment_fingerprints = Column(JSON, nullable=True)
    summary_incremental_update_count = Column(Integer, nullable=False, default=0)
