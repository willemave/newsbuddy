...
CONTRACT_ENUMS: list[EnumSpec] = [
    ...
    EnumSpec(BriefingFirstRunPhase, targets=Target.IOS | Target.CLI, open=False),
    EnumSpec(BriefingFirstRunSourceOutcome, targets=Target.IOS | Target.CLI, open=False),
    EnumSpec(ReadingExperience, targets=Target.IOS | Target.CLI, open=False),
    EnumSpec(BriefingBlockType, targets=Target.IOS | Target.CLI, open=False),
    EnumSpec(BriefingFigureAlignment, targets=Target.IOS | Target.CLI, open=False),
    EnumSpec(BriefingFigurePlacement, targets=Target.IOS | Target.CLI, open=False),
...
CONTRACT_MODELS: list[ModelSpec] = [
    ...
    ModelSpec(BriefingFirstRunProgress, targets=Target.IOS | Target.CLI),
    ...
    ModelSpec(BriefingDiscussionDto, targets=Target.IOS | Target.CLI),
    ...
    ModelSpec(BriefingNarrationResponse, targets=Target.IOS),
