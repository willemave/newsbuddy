...
def upgrade() -> None:
    ...
    op.add_column(
        "chat_sessions", sa.Column("council_persona_id", sa.String(length=64), nullable=True)
    )
    op.add_column(
    ...
    op.add_column(
        "chat_sessions", sa.Column("active_child_session_id", sa.Integer(), nullable=True)
    )
    op.add_column(
        "chat_sessions", sa.Column("branch_start_message_id", sa.Integer(), nullable=True)
    )
    op.add_column("chat_sessions", sa.Column("council_message_id", sa.Integer(), nullable=True))
    op.add_column(
        "chat_sessions",
        sa.Column(
            "is_hidden_from_history", sa.Boolean(), nullable=False, server_default=sa.false()
        ),
    )
