...
PALETTES = [
    ("petrol", "Petrol", "deep petrol blue-green mark, pale sand highlight, on warm taupe"),
    ...
    ("espresso", "Espresso", "deep warm espresso brown mark, soft blush highlight, on warm cream"),
