...
CONCEPTS = [
    ...
    (
        ...
        ENSO
        + "The brushed ring is noticeably thinner and lighter, and the open book is larger "
    ...
    (
        ...
        BOOKMARK
        + "Palette: soft sage green ribbon, deep forest green face details, on warm oat.",
    ),
    (
        "r5-11-mark-teal",
        "nano-banana-pro",
    ...
    (
        ...
        BOOKMARK
        + "Palette: soft muted gold ribbon, deep warm brown face details, on cream.",
    ),
    (
        "r5-14-mark-lavender",
        "nano-banana-pro-or",
    ...
    (
        ...
        READER
        + "Palette: deep indigo body, soft muted gold spectacles, on soft ivory.",
    ),
    (
        "r5-22-reader-rose",
        "gpt-image-2",
