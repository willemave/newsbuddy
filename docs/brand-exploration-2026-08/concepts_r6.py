...
CONCEPTS = [
    ...
    (
        ...
        ENSO
        + "cradling a small open book resting in the gap at the bottom of the ring. "
    ...
    (
        ...
        "contents.",
        ENSO
        + "cradling a small bookmark ribbon with a notched tail resting in the gap at the "
        "bottom of the ring. "
    ...
    (
        ...
        "most literally.",
        ENSO
        + "with a small soft rounded blob character wearing round spectacles sitting "
        "inside the ring. "
    ...
    (
        ...
        ENSO
        + "with a small soft rounded blob curled up asleep inside the ring, its eyes two "
        "simple closed arcs. "
    ...
    (
        ...
        "also a bookmark.",
        BLOB
        + "The bottom of its body ends in a notched swallow-tail like a bookmark ribbon. "
    ...
    (
        ...
        ENSO
        + "cradling a small open book in the gap at the bottom, the book carrying two tiny "
