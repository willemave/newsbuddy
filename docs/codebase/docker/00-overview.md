...
- `supervisord.conf` is the full single-container runtime: Postgres, API, content workers, media workers, image, onboarding, backfill, discussion, twitter, chat, audio-episode, llm, queue-watchdog, and scheduler programs.
