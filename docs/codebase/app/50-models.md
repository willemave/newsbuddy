...
- `app.models.metadata` owns persisted JSON metadata contracts, canonical summary-kind inference,
  and tolerant accessors.
...
| `metadata/` | Base/source metadata, summaries, article/podcast/news/insight report metadata, long-form artifacts, discussion metadata, accessors, state helpers, validation, and canonical summary-kind/version helpers. |
