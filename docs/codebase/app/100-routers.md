...
| `app/routers/admin.py` | `admin_dashboard`, `onboarding_lane_preview_page`, `onboarding_lane_preview`, `admin_eval_summaries_page`, `admin_eval_summaries_run`, `admin_conversational_page`, `admin_conversational_health`, `admin_conversational_ws` | Admin router for administrative functionality. |
| `app/routers/admin_conversational_models.py` | `AdminConversationalHealthResponse` | Pydantic models for admin conversational endpoints. |
