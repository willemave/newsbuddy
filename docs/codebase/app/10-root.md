...
## Purpose
Application root wiring for the FastAPI server and shared constants.
...
- Mounts generated content images at `/static/images` and packaged admin web assets at `/admin/static`.
...
- Admin HTML controllers, templates, and static assets live under `app/admin_web/`.
