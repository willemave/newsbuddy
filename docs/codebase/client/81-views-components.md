...
| Group | Files | Purpose |
|---|---|---|
| Cards and lists | `ContentCard.swift`, `LongFormCard.swift`, `NewsGroupCard.swift`, `ChatSessionCard.swift` | Reusable content/news/chat cards. |
...
| Actions and sheets | `TweetSuggestionsSheet.swift`, `ChatShareSheet.swift`, `DetailActionBar.swift`, `DetailChatSheet.swift`, `DetailHeroHeader.swift`, `DetailMiniSheets.swift`, `MiniSheetComponents.swift`, `LearningDeckCreateSheet.swift`, `LearningDeckContentCreateSheet.swift`, `LearningDeckListSheet.swift`, `LearningDeckRow.swift` | User action surfaces, detail hero chrome, and compact sheet controls. |
